                ...
                <div className="max-w-[1200px] mx-auto px-[20px] lg:px-[60px]">
                    <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                        ...
                        <div className="flex-1 w-full max-w-[500px] relative z-10">
                            {/* Glow */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-blue-100 rounded-full blur-[50px]"></div>
                            
                            {/* Desktop Monitor Base */}
                            <div className="relative mx-auto w-[340px] md:w-[420px] flex flex-col items-center transform hover:scale-105 transition-transform duration-500">
                                {/* Monitor Screen */}
                                <div className="w-full h-[220px] md:h-[260px] bg-[#161616] rounded-xl shadow-2xl p-2 border-b-[8px] border-[#333] relative z-10">
                                    <div className="w-full h-full bg-[#faf8fb] rounded-lg overflow-hidden relative flex flex-col items-center justify-center border-4 border-[#161616]">
                                        <div className="absolute top-3 right-4 text-[10px] font-bold text-[#888] flex items-center gap-1">
                                            <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></div> 02:45:10 remaining
                                        </div>
                                        ...
                                        <div className="text-center px-4 w-full">
                                            <div className="bg-white rounded-lg p-3 shadow-sm border border-[#f0eaf2] w-[80%] mx-auto">
                                                <div className="h-2 bg-[#f0eaf2] rounded-full w-3/4 mx-auto mb-2"></div>
                                                <div className="h-2 bg-[#f0eaf2] rounded-full w-full mx-auto mb-2"></div>
                                                <div className="h-2 bg-[#f0eaf2] rounded-full w-5/6 mx-auto"></div>
                                            </div>
                                            <div className="text-[#161616] font-bold text-[14px] mt-4">Section 2: Integrated Speaking</div>
                                        </div>
                                    </div>
                                </div>
                                {/* Monitor Stand */}
                                <div className="w-12 h-10 bg-[#e0e0e0] border-x-4 border-[#ccc] relative z-0"></div>
                                <div className="w-32 h-3 bg-[#ccc] rounded-t-lg shadow-md relative z-0"></div>
                                
                                {/* Keyboard abstract */}
                                <div className="w-[280px] h-[30px] bg-[#f5f5f5] rounded-lg border border-[#e0e0e0] shadow-sm mt-4 flex justify-between p-1">
                                    <div className="flex gap-1">
                                        <div className="w-4 h-full bg-[#e0e0e0] rounded-sm"></div>
                                        <div className="w-4 h-full bg-[#e0e0e0] rounded-sm"></div>
                                        <div className="w-4 h-full bg-[#e0e0e0] rounded-sm"></div>
                                    </div>
                                    <div className="w-32 h-full bg-[#e0e0e0] rounded-sm mx-auto"></div>
                                    <div className="flex gap-1">
                                        <div className="w-4 h-full bg-[#e0e0e0] rounded-sm"></div>
                                        <div className="w-4 h-full bg-[#e0e0e0] rounded-sm"></div>
                                        <div className="w-8 h-full bg-primary/20 rounded-sm border border-primary/30"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
