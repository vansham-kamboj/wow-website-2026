...
const StudentReviews = () => {
    ...
    return (
        <section className="py-[80px] min-[820px]:py-[120px] px-[20px] min-[820px]:px-[60px] bg-white overflow-hidden">
            <div className="max-w-[1200px] mx-auto flex flex-col min-[820px]:flex-row gap-[50px] min-[820px]:gap-[80px] items-start">
                ...
                <div className="w-full min-[820px]:w-[40%] min-[820px]:sticky min-[820px]:top-[120px]">
                    <h2 className="font-sans font-bold text-[36px] min-[820px]:text-[52px] leading-[1.1] text-[#161616] tracking-[-1px] mb-[30px]">
                        ...
                        <span className="text-[#c026d3] font-medium">real stories from our community!</span>
                    </h2>
                ...
                <div className="w-full min-[820px]:w-[60%] relative" style={{ height: '360px' }}>
                    {testimonials.map((t, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="bg-white rounded-[20px] p-[36px] min-[820px]:p-[48px] shadow-[0_8px_40px_rgba(192,38,211,0.08)] border border-[#f0eaf2]">
                                    
                                    {/* Quote mark */}
                                    <div className="font-serif text-[64px] leading-[1] text-[#c026d3]/15 mb-[10px]">
                                        &ldquo;
                                    </div>

                                    <p className="text-[17px] min-[820px]:text-[19px] leading-[1.7] text-[#2a2a2a] font-medium mb-[32px]">
                                        {t.text}
                                    </p>

                                    <div className="flex items-center justify-between">
                                        <div>
                                            <div className="font-quicksand font-bold text-[16px] text-[#161616]">{t.name}</div>
                                            <div className="text-[13px] text-[#767676] mt-[2px]">{t.since}</div>
                                        </div>
                                        <div className="text-[14px] font-medium text-[#c026d3] bg-[#f8f5fa] px-[16px] py-[6px] rounded-[6px]">
                                            {t.country}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <button 
                        onClick={handlePrev}
                        className="absolute left-[-20px] top-1/2 -translate-y-1/2 z-20 flex items-center justify-center w-[48px] h-[48px] rounded-[8px] border border-[#e8dced] bg-white text-[#c026d3] hover:bg-[#c026d3] hover:text-white hover:border-[#c026d3] transition-all duration-300 shadow-md"
                    >
                    ...
                    <button 
                        onClick={handleNext}
                        className="absolute right-[-20px] top-1/2 -translate-y-1/2 z-20 flex items-center justify-center w-[48px] h-[48px] rounded-[8px] border border-[#e8dced] bg-white text-[#c026d3] hover:bg-[#c026d3] hover:text-white hover:border-[#c026d3] transition-all duration-300 shadow-md"
                    >
