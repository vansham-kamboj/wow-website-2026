    ...
    return (
        <section className="bg-[#f8f5fa] pt-[56px] px-[20px] lg:px-[40px] pb-[64px]">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-[32px] lg:gap-y-0">
                ...
                <div className="py-[18px] px-0 lg:px-[28px] lg:border-l lg:border-[#e8dced]">
                    <span className="block text-[12px] text-[#8f8f8f] mb-[38px]">Sessions completed</span>
                    <span className="block font-sans font-semibold text-[36px] lg:text-[46px] text-primary tracking-[-1px]">12K+</span>
                </div>
                ...
                <div className="py-[18px] px-[28px] border-l border-[#e8dced]">
                    ...
                    <span className="block font-sans font-semibold text-[36px] lg:text-[46px] text-primary tracking-[-1px]">4.9</span>
                </div>
                
                <div className="py-[18px] px-0 lg:px-[28px] border-l-0 lg:border-l border-[#e8dced]">
                    <span className="block text-[12px] text-[#8f8f8f] mb-[38px] uppercase tracking-[0.6px]">Client Retention Rate</span>
                    <span className="block font-sans font-semibold text-[36px] lg:text-[46px] text-primary tracking-[-1px]">85%</span>
                </div>
                
                <div className="py-[18px] px-[28px] border-l border-[#e8dced]">
                    <span className="block text-[12px] text-[#8f8f8f] mb-[38px] uppercase tracking-[0.6px]">Years Running</span>
                    <span className="block font-sans font-semibold text-[36px] lg:text-[46px] text-primary tracking-[-1px]">6 years</span>
                </div>
