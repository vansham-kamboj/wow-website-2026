    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-end mb-[40px] px-[20px] lg:px-[60px] max-w-[1200px] mx-auto w-full relative z-10">
                ...
                <Button variant="custom" className="flex items-center gap-2 bg-[#f4d160] hover:bg-[#eac44e] text-[#161616] px-[24px] py-[12px] rounded-[8px] font-bold text-[14px] transition-colors shadow-sm h-auto">
                    View All Countries
